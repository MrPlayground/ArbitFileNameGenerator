...
function generateMissingNotes() {
    ...
    if (checkedCount > 0) {
        ...
        mainOutput = `Failure: Unable to locate ${items.join("/")} in ${portal}, Doc Mngmt will need to escalate to customer/IDR2RCM if no physical documents. - SS Doc Mgmt Team`;
    }
